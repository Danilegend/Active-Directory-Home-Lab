# project-it-environment
   ...
   >>## [Home](/README.md)
  >> [viikko-1](/docs/week-1.md) >> [viikko-2](/docs/week-2.md) >> [viikko-3](/docs/week-3.md) >> [viikko-4](/docs/week-4.md) >> [viikko-5](/docs/week-5.md)  >> [viikko-6](/docs/week-6.md) >> [viikko-7](/docs/week-7.md) >> [viikko-8](/docs/week-8.md) [viikko-9](/docs/week-9.md) 
...
- 👥 [Viikko 5 – Käyttäjät & ryhmät](docs/week-5.md)
...
- Windows Server ISO lataus
  >>## [Week 1 –  alkuasetukset](docs/week-1.md)
